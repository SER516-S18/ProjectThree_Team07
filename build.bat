...
jar cfm server.jar %ROOT_PATH%\manifest\server_manifest.txt lib src network util view
...
jar cfm client.jar %ROOT_PATH%\manifest\client_manifest.txt lib src network util view
